...
<div align="center">
  <table>
    ...
    <tr>
      <td align="right"><strong>メール認証コード：</strong></td>
...
<table align="center">
  <tr>
    <td align="center" valign="top">
      <a href="https://t.me/web3_dev_gg" target="_blank">Telegram サポート（クリックで開始）</a><br/>
      <img alt="Telegramサポート" src="./img/tg.png" width="220" style="border: 1px solid #e5e7eb; border-radius: 10px; padding: 2px;" /><br/>
    </td>
    <td align="center" valign="top">
      <a href="https://t.me/bitcoin5201688" target="_blank">Telegram グループ（クリックで参加）</a><br/>
      <img alt="Telegramグループ" src="./img/tg_group.png" width="220" style="border: 1px solid #e5e7eb; border-radius: 10px; padding: 2px;" /><br/>
    </td>
  </tr>
</table>
