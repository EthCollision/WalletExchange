...
<div align="center">
  <table>
    ...
    <tr>
      <td align="right"><strong>이메일 인증 코드:</strong></td>
...
<table align="center">
  <tr>
    <td align="center" valign="top">
      <a href="https://t.me/web3_dev_gg" target="_blank">Telegram 고객센터 (클릭하여 상담)</a><br/>
      <img alt="Telegram 고객센터" src="./img/tg.png" width="220" style="border: 1px solid #e5e7eb; border-radius: 10px; padding: 2px;" /><br/>
    </td>
    <td align="center" valign="top">
      <a href="https://t.me/bitcoin5201688" target="_blank">Telegram 그룹 (클릭하여 참여)</a><br/>
      <img alt="Telegram 그룹" src="./img/tg_group.png" width="220" style="border: 1px solid #e5e7eb; border-radius: 10px; padding: 2px;" /><br/>
    </td>
  </tr>
</table>
